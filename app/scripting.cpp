...
void _test(lk::invoke_t &cxt)
{
	...
	////ssc_data_set_number( data, "sco2ud_T_htf_cold_calc", 1.e38 );
	...
	////ssc_data_set_number( data, "_sco2_P_high_limit", 1.e38 );
	////ssc_data_set_number( data, "_sco2_P_ref", 1.e38 );
	////ssc_data_set_number( data, "_sco2_T_amb_des", 1.e38 );
	////ssc_data_set_number( data, "_sco2_T_approach", 1.e38 );
	////ssc_data_set_number( data, "_sco2_T_htf_hot_des", 1.e38 );
	////ssc_data_set_number( data, "_sco2_deltaT_PHX", 1.e38 );
	////ssc_data_set_number( data, "_sco2_design_eff", 1.e38 );
	////ssc_data_set_number( data, "_sco2_eta_c", 1.e38 );
	////ssc_data_set_number( data, "_sco2_eta_t", 1.e38 );
	////ssc_data_set_number( data, "_sco2_recup_eff_max", 1.e38 );
